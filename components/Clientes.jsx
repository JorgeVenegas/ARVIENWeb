    ...
    return (
        <div className="clientes-content">
            ...
            <div className="container text-center galery">
                <div class="row">
                    <div class="col">
                        <Image src="/../clientes/IMSS.webp" alt="IMSS" width={1000} height={1000} style={{ width: '55%', height: 'auto' }}/>
                    </div>
                    <div class="col">
                        <Image src="/../clientes/IMSS_Bienestar.webp" alt="IMSS_Bienestar" width={1000} height={1000} style={{ width: '50%', height: 'auto' }}/>
                    </div>
                    <div class="col">
                        <Image src="/../clientes/SEDENA.webp" alt="SEDENA" width={1000} height={1000} style={{ width: '90%', height: 'auto' }}/>
                    </div>
                    <div class="col">
                        <Image src="/../clientes/SEMAR.webp" alt="SEMAR" width={1000} height={1000} style={{ width: '90%', height: 'auto' }}/>
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <Image src="/../clientes/ISSEG_GTO.webp" alt="ISSEG_GTO" width={1000} height={1000} style={{ width: '80%', height: 'auto' }}/>
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <Image src="/../clientes/HRAEB.webp" alt="HRAEB" width={1000} height={1000} style={{ width: '50%', height: 'auto' }}/>
                    </div>
                    <div class="col">
